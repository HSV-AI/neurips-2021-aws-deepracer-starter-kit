...
class Agent:
    ...
    def play_step(self, net: nn.Module, epsilon: float = 0.0, device: str = "cpu") -> Tuple[float, bool]:
        ...
        new_state = new_state['STEREO_CAMERAS']
...
class DQNLightning(pl.LightningModule):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.net = RacerNet(self.env.observation_space.shape, n_actions)
        self.target_net = RacerNet(self.env.observation_space.shape, n_actions)
    ...
    def add_model_specific_args(parent_parser):  # pragma: no-cover
        ...
        parser.add_argument("--env", type=str, default="deepracer_gym:deepracer-v0")
        parser.add_argument("--gamma", type=float, default=0.99, help="discount factor")
        parser.add_argument("--sync_rate", type=int, default=7000, help="how many frames do we update the target network")
        parser.add_argument("--replay_size", type=int, default=1_000_000, help="capacity of the replay buffer")
        parser.add_argument(
            "--warm_start_steps",
            type=int,
            default=50_000,
        ...
        parser.add_argument("--eps_last_frame", type=int, default=100_000, help="what frame should epsilon stop decaying")
        parser.add_argument("--eps_start", type=float, default=1.0, help="starting value of epsilon")
        parser.add_argument("--eps_end", type=float, default=0.01, help="final value of epsilon")
        parser.add_argument("--episode_length", type=int, default=600, help="max length of an episode")
...
def main(args) -> None:
    ...
    trainer = pl.Trainer(gpus=1, strategy="dp", val_check_interval=1000)
